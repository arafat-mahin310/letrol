...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/arafatmahin310"])
...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +01925798757")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/arafat-mahin310/dj.txt.git').text
			if basesplit in plr:
				key = basesplit
